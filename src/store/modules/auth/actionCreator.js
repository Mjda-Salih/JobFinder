...
import { where, query, collection, getDocs, updateDoc, doc, setDoc } from "firebase/firestore"
...
const actions = {
    ...
    async register({ dispatch }, data){
        try{
            const { email, password, surname, firstName, address, contactNumber, type} = data;
